...
export const LEVEL_SPEC = Object.freeze({
    0: [CUBE_ID.COOKIE],
    1: [CUBE_ID.COOKIE, CUBE_ID.CEEKIO],
    2: [CUBE_ID.CHICKEN],
    3: [CUBE_ID.PIPE],
    4: [CUBE_ID.OGRE],
...
export const CUBE_LEVEL_INIT = {
    [CUBE_ID.COOKIE]:         {pos:[0,HALF_UNIT,0], t100: 0},
    [CUBE_ID.CEEKIO]:         {pos:[0,HALF_UNIT,0], t100: 0},
    ...
    [CUBE_ID.EVILEYE_STATIC]: {pos:[1,HALF_UNIT,1], t100: 0},
};
