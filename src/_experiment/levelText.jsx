const level1 = {
    ...
    intro: (
        <>
            <p>
                <strong>Cookie</strong> is a quiet, chocolate-flavored cube-shaped cookie
                who can always fold perfectly into a cube.
            </p>
            <br />
            <p>
                Her sister, <strong>Ceekio</strong>, is a quick-witted, blueberry-flavored
                girl who loves to <em>mimic</em> her — but something is always a little off.
            </p>
            <br />
            <p>
