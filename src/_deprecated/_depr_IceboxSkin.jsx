...
//     const waff_cone = cyl_mesh(ICEBOX_MAT.waff.tag, 
//         [0.02, 0.15, 0.45, 12], 
//     );
//     const scoop_plain = sphere_mesh(ICEBOX_MAT.plain.tag,
//         [0.13, a, b],[-0.08,-0.25,0],[p,0,0]
//     );
//     const scoop_straw = sphere_mesh(ICEBOX_MAT.staw.tag,
//         [0.13, a, b],[+0.025,-0.27,-0.08],[p,0,0]
//     );
//     const scoop_mint = sphere_mesh(ICEBOX_MAT.mint.tag,
//         [0.13, a, b],[+0.09,-0.25,+0.04],[p,0,0]
//     );
//     const scoop_blue = sphere_mesh(ICEBOX_MAT.blue.tag,
//         [0.13, a, b],[0,-0.35,0],[p,0,0]
//     );
//     const scoop_moon = sphere_mesh(ICEBOX_MAT.moon.tag,
//         [0.13, a, b],[0,-0.28,+0.08],[p,0,0]
//     );
...
// //                 />
// //             ))}
// //             {/* <Selector ctrl={ctrl} label='FT' rot={[0,0,0]}/>
// //             <Selector ctrl={ctrl} label='FR' rot={[0,q,0]}/>
// //             <Selector ctrl={ctrl} label='FD' rot={[0,p,0]}/>
// //             <Selector ctrl={ctrl} label='FL' rot={[0,-q,0]}/> */}
// //         </group>
// //     );
// // }

// // function Top({ctrl, label}) {
// //     return (
// //         <group>
// //             <BasicFrame label={label}/>
// //             <FaceLabelTextMesh label={label} />
// //             <Selector ctrl={ctrl} label='TB' rot={[0,0,0]}/>
// //             <Selector ctrl={ctrl} label='TR' rot={[0,q,0]}/>
// //             <Selector ctrl={ctrl} label='TF' rot={[0,p,0]}/>
// //             <Selector ctrl={ctrl} label='TL' rot={[0,-q,0]}/>
// //         </group>
// //     );
// // }

// // function Down({ctrl, label}) {
// //     return (
// //         <group>
// //             <BasicFrame label={label} />
// //             <FaceLabelTextMesh label={label} />
// //             <Selector ctrl={ctrl} label='DF' rot={[0,0,0]}/>
// //             <Selector ctrl={ctrl} label='DR' rot={[0,q,0]}/>
// //             <Selector ctrl={ctrl} label='DB' rot={[0,p,0]}/>
// //             <Selector ctrl={ctrl} label='DL' rot={[0,-q,0]}/>
// //         </group>
// //     );
// // }

// // function Back({ctrl, label}) {
// //     return (
// //         <group>
// //             <BasicFrame label={label} />
// //             <FaceLabelTextMesh label={label} />
// //             <Selector ctrl={ctrl} label='BT' rot={[0,0,0]}/>
// //             <Selector ctrl={ctrl} label='BL' rot={[0,q,0]}/>
// //             <Selector ctrl={ctrl} label='BD' rot={[0,p,0]}/>
// //             <Selector ctrl={ctrl} label='BR' rot={[0,-q,0]}/>
// //         </group>
// //     );
// // }

// // function Left({ctrl, label}) {
// //     return (
// //         <group>
// //             <BasicFrame label={label} />
// //             <FaceLabelTextMesh label={label} />
// //             <Selector ctrl={ctrl} label='LT' rot={[0,0,0]}/>
// //             <Selector ctrl={ctrl} label='LF' rot={[0,q,0]}/>
// //             <Selector ctrl={ctrl} label='LD' rot={[0,p,0]}/>
// //             <Selector ctrl={ctrl} label='LB' rot={[0,-q,0]}/>
// //         </group>
// //     );
// // }

// // function Right({ctrl, label}) {
// //     return (
// //         <group>
// //             <BasicFrame label={label} />
// //             <FaceLabelTextMesh label={label} />
// //             <Selector ctrl={ctrl} label='RT' rot={[0,0,0]}/>
// //             <Selector ctrl={ctrl} label='RB' rot={[0,q,0]}/>
// //             <Selector ctrl={ctrl} label='RD' rot={[0,p,0]}/>
// //             <Selector ctrl={ctrl} label='RF' rot={[0,-q,0]}/>
// //         </group>
// //     );
// // }
...
//     const ctrl = cubeControllerMap[cubeId];
//     // const FaceSkin = FACE_COMPONENT[label];
//     // return <FaceSkin ctrl={ctrl} label={label} />;
//     return (
//         <group>
//             <BasicFrame label={label} />
//             <FaceLabelTextMesh label={label} />
